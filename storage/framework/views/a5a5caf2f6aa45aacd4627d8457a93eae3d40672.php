    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo e(url('roles')); ?>" class="nav-link">Modul</a></li>
                ...
                <a href="" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    ...
                    <div class="media-body">
                      ...
                      <p class="tx-12 mg-b-0">I should be incapable of drawing a single stroke at the present
                        moment...
                      </p>
                    </div>
                  </div><!-- media -->
                ...
                <a href="" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    ...
                    <div class="media-body">
                      ...
                      <p class="tx-12 mg-b-0">When, while the lovely valley teems with vapour around me, and the
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="settings" role="tabpanel">
          ...
          <div class="pd-y-20 pd-x-25 tx-white">
            ...
            <p class="op-5 tx-13">Sign in using a two step verification by sending a verification code to your phone.
            </p>
            <div class="pos-relative">
...
</html><?php /**PATH C:\laragon\www\BracketAdmin\resources\views/panel/index.blade.php ENDPATH**/ ?>