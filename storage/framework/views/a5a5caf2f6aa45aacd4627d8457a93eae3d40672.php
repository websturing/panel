                                ...
                                <a href="" class="media-list-link">
                                    <div class="media pd-x-20 pd-y-15">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="tx-12 mg-b-0">A wonderful serenity has taken possession of my
                                ...
                                <a href="" class="media-list-link read">
                                    <div class="media pd-x-20 pd-y-15">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="tx-12 mg-b-0">I should be incapable of drawing a single stroke at
                                                the present
                                                moment...
                                            </p>
                                        </div>
                                ...
                                <a href="" class="media-list-link read">
                                    <div class="media pd-x-20 pd-y-15">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="tx-12 mg-b-0">When, while the lovely valley teems with vapour
                                                around me, and the
                            ...
                            <div class="media-list">
                                ...
                                <a href="" class="media-list-link read">
                                    <div class="media pd-x-20 pd-y-15">
                                        ...
                                        <div class="media-body">
                                            <p class="tx-13 mg-b-0 tx-gray-700"><strong
                                                    class="tx-medium tx-gray-800">Mellisa Brown</strong>
                                ...
                                <a href="" class="media-list-link read">
                                    <div class="media pd-x-20 pd-y-15">
                                        ...
                                        <div class="media-body">
                                            <p class="tx-13 mg-b-0 tx-gray-700"><strong
                                                    class="tx-medium tx-gray-800">Julius Erving</strong>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="settings" role="tabpanel">
                    ...
                    <div class="pd-y-20 pd-x-25 tx-white">
                        ...
                        <p class="op-5 tx-13">Sign in using a two step verification by sending a verification code to
                            your phone.
                        </p>
                        <div class="pos-relative">
...
<?php /**PATH C:\laragon\www\BracketAdmin\resources\views/panel/index.blade.php ENDPATH**/ ?>