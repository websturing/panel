...
var form = function form() {
  return Promise.all(/*! import() | roles */[__webpack_require__.e("vendors~roles"), __webpack_require__.e("roles")]).then(__webpack_require__.bind(null, /*! @/js/components/roles/modul_form */ "./resources/js/components/roles/modul_form.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$store.dispatch("StoreDatabase", this.page.crud).then(function (scs) {
      _this.nama = scs;
    });
